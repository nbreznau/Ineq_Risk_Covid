...
# Fix date & create mean of two types of risk perceptions (measurement model justifying this comes later)

cis <- cis %>%
  mutate(date = as.Date(StartDate),
         concern_self = mean(c(Corona_concerns_1,Corona_concerns_2,Corona_concerns_3), na.rm=T),
